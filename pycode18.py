...
class Ui_MainWindow:
    def __init__(self, root):
        ...
        self.combo_var.set("2300 x 6000")

        self.comboBox = ttk.Combobox(self.centralwidget, values=["2150 x 5000", "2300 x 6000"], textvariable=self.combo_var)
        self.comboBox.place(x=330, y=40, width=131, height=22)
        ...
        self.label = tk.Label(self.centralwidget, text="Rozmiar arkusza:")
        self.label.place(x=330, y=10, width=101, height=16)
    ...
    def generuj_ramki(self):
        rozmiar_combobox = self.combo_var.get()
        ...
        if " x " in rozmiar_combobox:
            ...
            try:
                ...
                szerokosc_transformed = (szerokosc / 100) * 2
                wysokosc_transformed = (wysokosc / 100) * 2
                ...
                for item in self.tableWidget.get_children():
                    ...
                    h = int(h)
                    ilosc = int(ilosc)
                    b_transformed = (b / 100) * 2
                    h_transformed = (h / 100) * 2
